...
"")
        ...
        self.lblCodFac_4.setGeometry(QtCore.QRect(200, 370, 660, 19))
        self.lblCodFac_4.setMaximumSize(QtCore.QSize(660, 19))
        font = QtGui.QFont()
        font.setPointSize(10)
        font.setBold(True)
        font.setWeight(75)
...
"")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("img/sair.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap("img/abrirArchivo.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap("img/subirNube.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionHacerBackup.setIcon(icon7)
        self.actionHacerBackup.setObjectName("actionHacerBackup")
        self.actionRestaurarBackup = QtWidgets.QAction(MainWindow)
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap("img/bajarNube.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRestaurarBackup.setIcon(icon8)
